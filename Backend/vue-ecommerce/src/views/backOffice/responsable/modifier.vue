...
export default {
    ...
    methods :{
        ...
        updateUser(){
            axios.put(`http://localhost:3500/responsable/gestion/modifier/${this.$route.params.id}`,{
                nom: this.nom,
                prenom: this.prenom,
    ...
    created(){
      axios.get( `http://localhost:3500/responsable/gestion/information/${this.$route.params.id}`).then((res)=>{
          const responsable = res.data.responsable
          this.nom = responsable.nom
          this.prenom = responsable.prenom
          this.email = responsable.email
          this.dateDeNaissance = responsable.dateDeNaissance
          this.telephone = responsable.telephone
          this.adresse = responsable.adresse
          this.pays = responsable.pays
          this.ville = responsable.ville
          this.codePostale = responsable.codePostale
          this.sexe = responsable.sexe
          this.role = responsable.role
      })
    }
